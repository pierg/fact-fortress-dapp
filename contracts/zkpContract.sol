...
contract ZkpContract {
    ...
    // (Note: this step has to be performed due to the current
    //         implementation of Noir: verifier smart contracts
    //         autogenerated by Noir does not accept public
    //         inputs as parameters to their verify function)
